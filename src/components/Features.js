        ...
        <div className="row row-cols-lg-3 row-cols-md-2 row-cols-1 text-center justify-content-center px-xl-6 aos-init aos-animate" data-aos="fade-up">
                ...
                <div className="card border-hover-primary hover-scale">
                    <div className="card-body">
                        <div className="text-primary mb-5">                           
                                <img src='https://vibegurukul-frontend.s3.ap-southeast-2.amazonaws.com/traditions.svg' width='100' height='100'></img>
                        </div>
            ...
            <div className="col my-3">
                <div className="card border-hover-primary hover-scale">
                    <div className="card-body">
                        <div className="text-primary mb-5">
                            <img src='https://vibegurukul-frontend.s3.ap-southeast-2.amazonaws.com/hindu.svg' width='100' height='100'></img>
                        </div>
            ...
            <div className="col my-3">
                <div className="card border-hover-primary hover-scale">
                    <div className="card-body">
                        <div className="text-primary mb-5">
                            <img src='https://vibegurukul-frontend.s3.ap-southeast-2.amazonaws.com/itihas-of-bharat.svg' width='100' height='100'></img>
                        </div>
